    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Category>>> GetCategory()
        {
          if (_context.Category == null)
          {
            ...
            var ans = await _context.Category.Include(_ => _.Cars).ToListAsync();
            return Ok(ans);
        }
        ...
        private Category mapCar(CategoryDto payload)
        {
            ...
            foreach (var item in payload.Cars)
            {
                var newCars = new Car();
        ...
        public async Task<ActionResult<Category>> PostCategory(CategoryDto category)
        {
          ...
          if (_context.Category == null)
          {
              return Problem("Entity set 'CarDbContext.Category'  is null.");
          }
            _context.Category.Add(newCar);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetCategory", new { id = category.CategoryId }, newCar);
        }
